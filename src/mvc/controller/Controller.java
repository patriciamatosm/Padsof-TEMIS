...
public class Controller {
    ...
    public String getLoggedUserName() {
        return pTemis.getUsuarioConectado().getNombre();
    }
     ...
     */
    public String getNumVotos(Proyecto p) {
        return p.getNumVotos().toString();
    }
     ...
     *
     * @param c colectivo
     * @return true/false en caso de que este suscrito
     */
    public boolean subscribirseNoticias(Colectivo c) {
        if (this.getLoggedUser().getSuscritoNoticias().contains(c)) {
            return true;
        }
        pTemis.subscribirseNoticias(c);
        return false;
    }

    /**
     * Funcion que devuelve si un usuario esta suscrito a las noticas del colectivo
     *
     * @param c colectivo
     * @param u usuario
     * @return true/false
     */
    public boolean isSuscrito(Colectivo c, Usuario u) {
        return u.getSuscritoNoticias().contains(c);
    }
     ...
     */
    public void setColRep(Colectivo c) {
        pTemis.setColRepresentado(c);
    }
     ...
     */
    public Colectivo getColRep() {
        return pTemis.getColRepresentado();
    }
     ...
     */
    public String getNombreColectivo(Colectivo c) {
        return c.getNombre();
    }
     ...
     */
    public String getDescripcion(Colectivo c) {
    ...
    public boolean getRepresentante() {
        return pTemis.isRepresentanteLegal();
    }
     ...
     */
    public void setRepresentante(boolean bool) {
        pTemis.setRepresentanteLegal(bool);
    }
     ...
     */
    public String getDescProy(Proyecto p) {
     ...
     */
    public String getGrupo(ProyectoSocial p) {
        return p.getGrupoEtnico();
    }
     ...
     */
    public String getDistrito(ProyectoInfraestructura p) {
        return p.getDistrito();
    }
     ...
     */
    public String getUrl(ProyectoInfraestructura p) {
        return p.getUrlCroquis();
    }
     ...
     */
    public String getMensaje(Notificacion n) {
        return n.getMensaje();
    }
    ...
    public List<String> getDistritos() {
        return Temis.getInstance().getDistritos();
    }
